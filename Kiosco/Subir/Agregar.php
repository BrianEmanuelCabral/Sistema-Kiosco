...
mysqli_query($conexion, "INSERT INTO productos (nombre,precio,cantidad,imagen) VALUES ('$nombre','$precio','$cantidad','$imagen')");
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                  <a class="bi nav-link active" aria-current="page" href="#">Nuevo Producto</a>
                </li>
                <li class="nav-item">
                  <a class="bi nav-link" href="http://localhost/Kiosco/Subir/ListaProductos.php">Lista de Productos</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container" style="margin-top: 5rem; width: 100vh;">
          <div class="card">
            <div class="card-header m-0">
              <h1 class="card-title text-center">Se ha subido el producto</h1>
            </div>
            <div class="card-body m-0 d-flex justify-content-center">
              <form action="NuevoProducto.html" method="get">
