<?php
  ...
  mysqli_query($conexion, "UPDATE productos set nombre='$nombre',precio=$precio,cantidad=$cantidad,imagen='$imagen' where id=$id");
      ...
      <div class="container" style="margin-top: 5rem; width: 100vh;">
          <div class="card">
            <div class="card-header m-0">
              <h1 class="card-title text-center">Se ha actualizado el producto</h1>
            </div>
